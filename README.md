...
Blueprint is a clinical Session management web application designed to support psychologists and clinical teams in managing patients, sessions in a structured and efficient way.

Built in collaboration with a clinical psychologist at a private mental health hospital, Blueprint has evolved through multiple rounds of real stakeholder testing and feedback from a ward-based management dashboard (v1.0) to a session-focused clinical workflow tool (v1.5).
