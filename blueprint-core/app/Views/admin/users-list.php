...
<style>
    ...
    .badge-admin { display: inline-block; padding: 2px 8px; border-radius: 2rem; font-size: 0.7rem; font-weight: 600; background: #ede9fe; color: #6d28d9; }
 ...
 .btn-action {
    ...
    .you-badge { display: inline-block; padding: 1px 6px; border-radius: 2rem; font-size: 0.65rem; font-weight: 600; background: #e0f2fe; color: #0369a1; margin-left: 0.3rem; }

    .edit-modal { display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 1000; align-items: center; justify-content: center; }
    .edit-modal.open { display: flex; }
    .edit-modal-content { background: white; border-radius: 1rem; padding: 2rem; width: 100%; max-width: 420px; box-shadow: 0 20px 60px rgba(0,0,0,0.15); }
    .edit-modal-content h3 { font-size: 1.1rem; font-weight: 700; color: #1e3a8a; margin: 0 0 1.25rem; }
    .edit-modal-content .form-group { margin-bottom: 1rem; }
    .edit-modal-content label { display: block; font-size: 0.8rem; font-weight: 600; color: #475569; margin-bottom: 0.4rem; }
    .edit-modal-content input { width: 100%; padding: 0.6rem 0.85rem; border: 1.5px solid #e2e8f0; border-radius: 0.5rem; font-size: 0.88rem; color: #1e293b; background: #f8fafc; box-sizing: border-box; outline: none; }
    .edit-modal-content input:focus { border-color: #1e3a8a; box-shadow: 0 0 0 3px rgba(30,58,138,0.08); background: white; }
    .edit-modal-actions { display: flex; gap: 0.75rem; justify-content: flex-end; margin-top: 1.5rem; }
    .btn-cancel { padding: 0.6rem 1.2rem; border: 1px solid #e2e8f0; border-radius: 0.5rem; background: white; color: #475569; font-size: 0.85rem; font-weight: 500; cursor: pointer; }
    .btn-save { padding: 0.6rem 1.2rem; border: none; border-radius: 0.5rem; background: #1e3a8a; color: white; font-size: 0.85rem; font-weight: 500; cursor: pointer; }
    .btn-save:hover { background: #1e40af; }

    .toast-msg { position: fixed; bottom: 1.5rem; right: 1.5rem; background: #1e3a8a; color: white; padding: 0.75rem 1.25rem; border-radius: 0.75rem; font-size: 0.85rem; font-weight: 500; box-shadow: 0 4px 16px rgba(0,0,0,0.15); z-index: 9999; display: none; }
...
<div class="admin-page">
    ...
    <?php if (isset($_GET['created'])): ?>
        <div style="background:#d1fae5;color:#065f46;border:1px solid #6ee7b7;border-radius:0.6rem;padding:0.75rem 1rem;margin-bottom:1rem;font-size:0.85rem;">
            <i class="bi bi-check-circle"></i> Invitation sent successfully.
        </div>
    <?php endif; ?>
    ...
    <div class="admin-header">
        <div>
            ...
            <p>Manage all Blueprint user accounts.</p>
        </div>
