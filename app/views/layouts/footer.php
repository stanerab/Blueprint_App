    ...
    <footer class="mt-5 pt-5 pb-4 text-white" style="background: linear-gradient(90deg, #1e3a8a, #2563eb);">
        <div class="container">
            <div class="row g-4">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-unstyled small">
                        <li><a href="<?= url('dashboard') ?>" class="text-white-50 text-decoration-none">Dashboard</a></li>
                        <li><a href="<?= url('wards/hope') ?>" class="text-white-50 text-decoration-none">Hope Ward</a></li>
                        <li><a href="<?= url('wards/manor') ?>" class="text-white-50 text-decoration-none">Manor Ward</a></li>
                        <li><a href="<?= url('wards/lakeside') ?>" class="text-white-50 text-decoration-none">Lakeside Ward</a></li>
                    </ul>
                </div>
               <!-- <div class="col-md-3">
